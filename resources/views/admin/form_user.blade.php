					...
					<div class="widget-content nopadding">
						...
						<form action="{{ route('admin.user.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span11" placeholder="User name" name="name" value="{!! old('name') !!}"/> *
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Email:</label>
								<div class="controls">
									<input type="text" class="span11" placeholder="User email" name="email" value="{!! old('email') !!}"/> *
								</div>
							</div>
							<div class="control-group">
