...
j).color(e.map(function(e,t){return e.color||c(e,t)}).filter(function(t,n){return!e[n].disabled})),U.select(".nv-distWrap").append("g").attr("class","nv-distributionY"),z.select(".nv-distributionY").attr("transform","translate("+(b?C:-u.size())+",0)").datum(e.filter(function(e){return!e.disabled})).call(u)),d3.fisheye&&(z.select(".nv-background").attr("width",C).attr("height",j),z.select(".nv-background").on("mousemove",$),z.select(".nv-background").on("click",function(){S=!S}),t.dispatch.on("elementClick.freezeFisheye",function(){S=!S})),s.dispatch.on("legendClick",function(e,i){e.disabled=!e.disabled,E=e.disabled?0:2.5,z.select(".nv-background").style("pointer-events",e.disabled?"none":"all"),z.select(".nv-point-paths").style("pointer-events",e.disabled?"all":"none"),e.disabled?(h.distortion(E).focus(0),p.distortion(E).focus(0),z.select(".nv-scatterWrap").call(t),z.select(".nv-x.nv-axis").call(n),z.select(".nv-y.nv-axis").call(r)):S=!1,B.update()}),i.dispatch.on("stateChange",function(e){k=e,A.stateChange(k),B.update()}),t.dispatch.on("elementMouseover.tooltip",function(e){d3.select(".nv-chart-"+t.id()+" .nv-series-"+e.seriesIndex+" .nv-distx-"+e.pointIndex).attr("y1",e.pos[1]-j),d3.select(".nv-chart-"+t.id()+" .nv-series-"+e.seriesIndex+" .nv-disty-"+e.pointIndex).attr("x2",e.pos[0]+o.size()),e.pos=[e.pos[0]+a.left,e.pos[1]+a.top],A.tooltipShow(e)}),A.on("tooltipShow",function(e){x&&P(e,N.parentNode)}),A.on("changeState",function(t){typeof t.disabled!="undefined"&&(e.forEach(function(e,n){e.disabled=t.disabled[n]}),k.disabled=t.disabled),B.update()}),_=h.copy(),D=p.copy()}),B}var t=e.models.scatter(),n=e.models.axis(),r=e.models.axis(),i=e.models.legend(),s=e.models.legend(),o=e.models.distribution(),u=e.models.distribution(),a={top:30,right:20,bottom:50,left:75},f=null,l=null,c=e.utils.defaultColor(),h=d3.fisheye?d3.fisheye.scale(d3.scale.linear).distortion(0):t.xScale(),p=d3.fisheye?d3.fisheye.scale(d3.scale.linear).distortion(0):t.yScale(),d=!1,v=!1,m=!0,g=!0,y=!0,b=!1,w=!!d3.fisheye,E=0,S=!1,x=!0,T=function(e,t,n){return"<strong>"+t+"</strong>"},N=function(e,t,n){return"<strong>"+n+"</strong>"},C=function(e,t,n,r){return"<h3>"+e+"</h3>"+"<p>"+r+"</p>"},k={},L=null,A=d3.dispatch("tooltipShow","tooltipHide","stateChange","changeState"),O="No Data Available.",M=250;t.xScale(h).yScale(p),n.orient("bottom").tickPadding(10),r.orient(b?"right":"left").tickPadding(10),o.axis("x"),u.axis("y"),s.updateState(!1);var _,D,P=function(i,s){var o=i.pos[0]+(s.offsetLeft||0),u=i.pos[1]+(s.offsetTop||0),f=i.pos[0]+(s.offsetLeft||0),l=p.range()[0]+a.top+(s.offsetTop||0),c=h.range()[0]+a.left+(s.offsetLeft||0),d=i.pos[1]+(s.offsetTop||0),v=n.tickFormat()(t.x()(i.point,i.pointIndex)),m=r.tickFormat()(t.y()(i.point,i.pointIndex));T!=null&&e.tooltip.show([f,l],T(i.series.key,v,m,i,B),"n",1,s,"x-nvtooltip"),N!=null&&e.tooltip.show([c,d],N(i.series.key,v,m,i,B),"e",1,s,"y-nvtooltip"),C!=null&&e.tooltip.show([o,u],C(i.series.key,v,m,i.point.tooltip,i,B),i.value<0?"n":"s",null,s)},H=[{key:"Magnify",disabled:!0}];return t.dispatch.on("elementMouseout.tooltip",function(e){A.tooltipHide(e),d3.select(".nv-chart-"+t.id()+" .nv-series-"+e.seriesIndex+" .nv-distx-"+e.pointIndex).attr("y1",0),d3.select(".nv-chart-"+t.id()+" .nv-series-"+e.seriesIndex+" .nv-disty-"+e.pointIndex).attr("x2",u.size())}),A.on("tooltipHide",function(){x&&e.tooltip.cleanup()}),B.dispatch=A,B.scatter=t,B.legend=i,B.controls=s,B.xAxis=n,B.yAxis=r,B.distX=o,B.distY=u,d3.rebind(B,t,"id","interactive","pointActive","x","y","shape","size","xScale","yScale","zScale","xDomain","yDomain","xRange","yRange","sizeDomain","sizeRange","forceX","forceY","forceSize","clipVoronoi","clipRadius","useVoronoi"),B.options=e.utils.optionsFunc.bind(B),B.margin=function(e){return arguments.length?(a.top=typeof e.top!="undefined"?e.top:a.top,a.right=typeof e.right!="undefined"?e.right:a.right,a.bottom=typeof e.bottom!="undefined"?e.bottom:a.bottom,a.left=typeof e.left!="undefined"?e.left:a.left,B):a},B.width=function(e){return arguments.length?(f=e,B):f},B.height=function(e){return arguments.length?(l=e,B):l},B.color=function(t){return arguments.length?(c=e.utils.getColor(t),i.color(c),o.color(c),u.color(c),B):c},B.showDistX=function(e){return arguments.length?(d=e,B):d},B.showDistY=function(e){return arguments.length?(v=e,B):v},B.showControls=function(e){return arguments.length?(w=e,B):w},B.showLegend=function(e){return arguments.length?(m=e,B):m},B.showXAxis=function(e){return arguments.length?(g=e,B):g},B.showYAxis=function(e){return arguments.length?(y=e,B):y},B.rightAlignYAxis=function(e){return arguments.length?(b=e,r.orient(e?"right":"left"),B):b},B.fisheye=function(e){return arguments.length?(E=e,B):E},B.tooltips=function(e){return arguments.length?(x=e,B):x},B.tooltipContent=function(e){return arguments.length?(C=e,B):C},B.tooltipXContent=function(e){return arguments.length?(T=e,B):T},B.tooltipYContent=function(e){return arguments.length?(N=e,B):N},B.state=function(e){return arguments.length?(k=e,B):k},B.defaultState=function(e){return arguments.length?(L=e,B):L},B.noData=function(e){return arguments.length?(O=e,B):O},B.transitionDuration=function(e){return arguments.length?(M=e,B):M},B},e.models.sparkline=function(){"use strict";function d(e){return e.each(function(e){var i=n-t.left-t.right,d=r-t.top-t.bottom,v=d3.select(this);s.domain(l||d3.extent(e,u)).range(h||[0,i]),o.domain(c||d3.extent(e,a)).range(p||[d,0]);var m=v.selectAll("g.nv-wrap.nv-sparkline").data([e]),g=m.enter().append("g").attr("class","nvd3 nv-wrap nv-sparkline"),b=g.append("g"),w=m.select("g");m.attr("transform","translate("+t.left+","+t.top+")");var E=m.selectAll("path").data(function(e){return[e]});E.enter().append("path"),E.exit().remove(),E.style("stroke",function(e,t){return e.color||f(e,t)}).attr("d",d3.svg.line().x(function(e,t){return s(u(e,t))}).y(function(e,t){return o(a(e,t))}));var S=m.selectAll("circle.nv-point").data(function(e){function n(t){if(t!=-1){var n=e[t];return n.pointIndex=t,n}return null}var t=e.map(function(e,t){return a(e,t)}),r=n(t.lastIndexOf(o.domain()[1])),i=n(t.indexOf(o.domain()[0])),s=n(t.length-1);return[i,r,s].filter(function(e){return e!=null})});S.enter().append("circle"),S.exit().remove(),S.attr("cx",function(e,t){return s(u(e,e.pointIndex))}).attr("cy",function(e,t){return o(a(e,e.pointIndex))}).attr("r",2).attr("class",function(e,t){return u(e,e.pointIndex)==s.domain()[1]?"nv-point nv-currentValue":a(e,e.pointIndex)==o.domain()[0]?"nv-point nv-minValue":"nv-point nv-maxValue"})}),d}var t={top:2,right:0,bottom:2,left:0},n=400,r=32,i=!0,s=d3.scale.linear(),o=d3.scale.linear(),u=function(e){return e.x},a=function(e){return e.y},f=e.utils.getColor(["#000"]),l,c,h,p;return d.options=e.utils.optionsFunc.bind(d),d.margin=function(e){return arguments.length?(t.top=typeof e.top!="undefined"?e.top:t.top,t.right=typeof e.right!="undefined"?e.right:t.right,t.bottom=typeof e.bottom!="undefined"?e.bottom:t.bottom,t.left=typeof e.left!="undefined"?e.left:t.left,d):t},d.width=function(e){return arguments.length?(n=e,d):n},d.height=function(e){return arguments.length?(r=e,d):r},d.x=function(e){return arguments.length?(u=d3.functor(e),d):u},d.y=function(e){return arguments.length?(a=d3.functor(e),d):a},d.xScale=function(e){return arguments.length?(s=e,d):s},d.yScale=function(e){return arguments.length?(o=e,d):o},d.xDomain=function(e){return arguments.length?(l=e,d):l},d.yDomain=function(e){return arguments.length?(c=e,d):c},d.xRange=function(e){return arguments.length?(h=e,d):h},d.yRange=function(e){return arguments.length?(p=e,d):p},d.animate=function(e){return arguments.length?(i=e,d):i},d.color=function(t){return arguments.length?(f=e.utils.getColor(t),d):f},d},e.models.sparklinePlus=function(){"use strict";function v(e){return e.each(function(c){function O(){if(a)return;var e=C.selectAll(".nv-hoverValue").data(u),r=e.enter().append("g").attr("class","nv-hoverValue").style("stroke-opacity",0).style("fill-opacity",0);e.exit().transition().duration(250).style("stroke-opacity",0).style("fill-opacity",0).remove(),e.attr("transform",function(e){return"translate("+s(t.x()(c[e],e))+",0)"}).transition().duration(250).style("stroke-opacity",1).style("fill-opacity",1);if(!u.length)return;r.append("line").attr("x1",0).attr("y1",-n.top).attr("x2",0).attr("y2",b),r.append("text").attr("class","nv-xValue").attr("x",-6).attr("y",-n.top).attr("text-anchor","end").attr("dy",".9em"),C.select(".nv-hoverValue .nv-xValue").text(f(t.x()(c[u[0]],u[0]))),r.append("text").attr("class","nv-yValue").attr("x",6).attr("y",-n.top).attr("text-anchor","start").attr("dy",".9em"),C.select(".nv-hoverValue .nv-yValue").text(l(t.y()(c[u[0]],u[0])))}function M(){function r(e,n){var r=Math.abs(t.x()(e[0],0)-n),i=0;for(var s=0;s<e.length;s++)Math.abs(t.x()(e[s],s)-n)<r&&(r=Math.abs(t.x()(e[s],s)-n),i=s);return i}if(a)return;var e=d3.mouse(this)[0]-n.left;u=[r(c,Math.round(s.invert(e)))],O()}var m=d3.select(this),g=(r||parseInt(m.style("width"))||960)-n.left-n.right,b=(i||parseInt(m.style("height"))||400)-n.top-n.bottom;v.update=function(){v(e)},v.container=this;if(!c||!c.length){var w=m.selectAll(".nv-noData").data([d]);return w.enter().append("text").attr("class","nvd3 nv-noData").attr("dy","-.7em").style("text-anchor","middle"),w.attr("x",n.left+g/2).attr("y",n.top+b/2).text(function(e){return e}),v}m.selectAll(".nv-noData").remove();var E=t.y()(c[c.length-1],c.length-1);s=t.xScale(),o=t.yScale();var S=m.selectAll("g.nv-wrap.nv-sparklineplus").data([c]),T=S.enter().append("g").attr("class","nvd3 nv-wrap nv-sparklineplus"),N=T.append("g"),C=S.select("g");N.append("g").attr("class","nv-sparklineWrap"),N.append("g").attr("class","nv-valueWrap"),N.append("g").attr("class","nv-hoverArea"),S.attr("transform","translate("+n.left+","+n.top+")");var k=C.select(".nv-sparklineWrap");t.width(g).height(b),k.call(t);var L=C.select(".nv-valueWrap"),A=L.selectAll(".nv-currentValue").data([E]);A.enter().append("text").attr("class","nv-currentValue").attr("dx",p?-8:8).attr("dy",".9em").style("text-anchor",p?"end":"start"),A.attr("x",g+(p?n.right:0)).attr("y",h?function(e){return o(e)}:0).style("fill",t.color()(c[c.length-1],c.length-1)).text(l(E)),N.select(".nv-hoverArea").append("rect").on("mousemove",M).on("click",function(){a=!a}).on("mouseout",function(){u=[],O()}),C.select(".nv-hoverArea rect").attr("transform",function(e){return"translate("+ -n.left+","+ -n.top+")"}).attr("width",g+n.left+n.right).attr("height",b+n.top)}),v}var t=e.models.sparkline(),n={top:15,right:100,bottom:10,left:50},r=null,i=null,s,o,u=[],a=!1,f=d3.format(",r"),l=d3.format(",.2f"),c=!0,h=!0,p=!1,d="No Data Available.";return v.sparkline=t,d3.rebind(v,t,"x","y","xScale","yScale","color"),v.options=e.utils.optionsFunc.bind(v),v.margin=function(e){return arguments.length?(n.top=typeof e.top!="undefined"?e.top:n.top,n.right=typeof e.right!="undefined"?e.right:n.right,n.bottom=typeof e.bottom!="undefined"?e.bottom:n.bottom,n.left=typeof e.left!="undefined"?e.left:n.left,v):n},v.width=function(e){return arguments.length?(r=e,v):r},v.height=function(e){return arguments.length?(i=e,v):i},v.xTickFormat=function(e){return arguments.length?(f=e,v):f},v.yTickFormat=function(e){return arguments.length?(l=e,v):l},v.showValue=function(e){return arguments.length?(c=e,v):c},v.alignValue=function(e){return arguments.length?(h=e,v):h},v.rightAlignValue=function(e){return arguments.length?(p=e,v):p},v.noData=function(e){return arguments.length?(d=e,v):d},v},e.models.stackedArea=function(){"use strict";function g(e){return e.each(function(e){var a=n-t.left-t.right,b=r-t.top-t.bottom,w=d3.select(this);p=v.xScale(),d=v.yScale();var E=e;e.forEach(function(e,t){e.seriesIndex=t,e.values=e.values.map(function(e,n){return e.index=n,e.seriesIndex=t,e})});var S=e.filter(function(e){return!e.disabled});e=d3.layout.stack().order(l).offset(f).values(function(e){return e.values}).x(o).y(u).out(function(e,t,n){var r=u(e)===0?0:n;e.display={y:r,y0:t}})(S);var T=w.selectAll("g.nv-wrap.nv-stackedarea").data([e]),N=T.enter().append("g").attr("class","nvd3 nv-wrap nv-stackedarea"),C=N.append("defs"),k=N.append("g"),L=T.select("g");k.append("g").attr("class","nv-areaWrap"),k.append("g").attr("class","nv-scatterWrap"),T.att»8¶Fhì´ÁFU»“¶/ŒåÑ#ã¤Š/ú;;ÁO~ş­âVE¼ù{qÇ—ºZ"ÿï]ñR—¿RÇÄÁ!/§>‡»·Ibì¡ı ›óàÍ¶Íx¤hwÓş§Á ¬OñZIû©—²qÅà;¯Tpÿ‰N a*ñhú±Ø#~{t’@×j`Ó4•$¢&óç¨5èÆ5ãÉu'®vmŸ$u;Óo›T]=®‹GòmäÌM`;ú™$÷¸N7°‡:§'ÍºbípqIšb–xqÈC¯ß¹.Eüˆ°Çrè¥lxÿ0OÊ8º?Ogu¥X>À¿8¡Kpißo’Ô¯Ör~bzíµ~¸B†ğiüíiD¾Üö¸ÊÄsvIÃi?)&$(
‰A‹@Ÿµ?ñèXmø1#ì·c£è°w¾²
¤9†Ø0ğ]½JîÉ46	+Üt–É‰\¥r`ã>^åµ <Å­Âõ™OH’ßQ|Ø¾s'Gèq§]°ê“{™ÿ€Hµòj±Fösÿ3¥ß@ _\·¤5RÔgm²ñ¶”·œÀºÆL–œŞ¹zãÜğÑ¼×çÙ$q Ì‚m²~şH{Æº™m#%wŸ_!Pu‹ŒÍÖ	"Vûnd¢a9§¡Ó(kO‡¢×àîcÉy¥É.Æ‡Ên¾É PæĞötUÆ·q.Õuœm<Óê	ÀÒmIj*\«ıxèıôb~éğÑ"sz(ä£Ô–'–™krç¯sş·4{3Uf=$:Ó(.ëĞòc¼õ3Ü¶®‡/¶@Ú_úr®¹cé‘x<úLá@Õ5’ìÖœŸûı7éğÉÎcØP¿ËåÇí_Ì¤¹u›Bnú´ÜNfÊšJ…`ÇèÆd‹®úÙ9É“eŞ°’ÙHZLj-ÿğí	µŞ‹g;°
45åÈÏo´å¾20:¦µG±@Ù/á«¢”<õ2+Àƒ›U+»Û®j¦án†Õ×­l@*oq·62½»üõb ¿™o@—} 	Ç…ŸÆ‡¨®?×Œ0Qó $Å…²a¤6Ê^k˜šĞ]Æİ,ÏÍ
'Bûœ¤ùC5iyÎqM*1ÃL™æß¨ÈS½~ÍİÖvôhÕš&0~Ú:a½V÷¤•L_›=ËèN:t›7^äÇ‰ÏõûÛñÓ6%;Gá6ğEhR¥(Š„–½ç“(}“ÔÀÓ7C‡"OİÀ9rL½SSxñNÃAÖú¾¢‡“ ÑÕ?Ùû2’Tóvâ ü˜œÚ!ÅY¡aÜ}»JöÖ”SÏ¶©Á‡Mòùh¹|ıúşĞì&Î+ØXŠ‡E?ìY½ªÚªw~Ö6„ç-6‰X£û¢6!(ÏöïØRHñåøàV%,Ğî‹2ã©£ ‰‚»ö‡øÓ{öy<#y)\`/%PÀW·Ï‚qİˆoËì}ìŠ­ğóçÈç].—ĞìR¥¹{inÀ¶ò²aı>+…Íò.$Ù.ÜákW@ ¯Rpz½$:µ·a·ıŠÁ´M%ó/åLÀç`Q v=·üÒ~êóåm”"è(:)‘›õc‡´Ò/¾¹ò£†@ûaé"¿<Oéú³WğüÙj©“*8ì—Ä“ÄÌ_£¶Êáå·WiĞÂ–Ö¢x@qŠ¡ßv+ûmõ*qÿVg%éJQ¢"Iê,‡ç6øØ¤Æ$a½¿D½‘—‘›Õ®årÏïùF şf5,§d Qà<ç“He³
1[,¨Ò»Å19)DbİÍì½%Ët>¸Õ:¿nÃÆƒuc›ÕúB­®]ÙN ^ØÌ¬©ÄPÏ£èsÎ—ÑT¾vüB½´8ÍE¨B”Æ]Õ!—ŒRÙo›ºûèĞš-øùd%HTµ;`wåæà×F}a¤°Q_)C"íÛşYïôB¢¼¯VcÏÓf)†§ãˆ
™èUjÀë#ës‚í¿©°ÖPJ·…®gëÕÊH‘™×É‹XkUÀÒïjğ|º{ê2ïg	¿ş`åò®N	×ùI&‹‚Ïñ1Z¸F ‡6dNz³ı/Ÿh­¾x¸ÓwÚ{naì fÈçûÃ¿-ŞRçñ¢òÏÛàÁß£Õ5/ èœ§Hİ¡CfŸÙiØ©"€
-Ë}ô]ı¹Ç¬X0Z²Õ¨ª	ùísÕ˜àY¶ö±ŒjÂÂù¶”ş$qß7{@ƒ¦-É	ag˜1gÑ=Ô’¢á|ßµ1?-<mK£ÌğğÖÒuHq®3üÏËÎXPÏrÀ¿‘†$a	É›ıñ>¿„ˆş´å&ÕE*·¹‹×PS”™ÉßÚŒ]€@¾1úxªÿÓ!_éËfAºÑ%‹¯#ûb¿èŞ8Ü,©ùÑéTíS“c=Ûú¢#Ùn[\Íò¶|vWÅ2Kqî0'ŸÏPËú·ÿŠŸXcô…yXsà÷l!‰÷—‚3÷&JWW1ra×NaÀæ[l­£>3]KÊX§t÷<üQ-e½ƒKÎÖH6÷Øc-;VñŠaÓĞµ	ªkıÎ=üEƒFïöŞ…S¸Roæì°ÜU7€¬Î}óX± 5ÎK÷  eVÊG”o‰ìşte!Õ2š¯ï Ã6PÂñÆ¨']R3ª™&Ş³7K‹oº”y4f‰¿ M>¦P³•Sğ=V‡x„qôÅÕ—øgQ» ¶!J‡!{Íà”÷Í¨ÃıBÏÃ›‚¶oó.ÌıÿSiB7C¢ÁÅÎoËôIYË=îVS¬Œ’I(ó¨ş—dô¥ëŠQ«ŞRßJª‰$cÛ6È Ú/<Â2Ô'NŒ’L•0ƒ²ÜúŠçoX­;ßãf‰cå=>pœº”ÛĞïc<NÃÁ)8ê¦³€Ïd÷Ì!ÍóÚş¿-í›©™tÈH¾¿|ÜÈ£5âÙõ¦Ú’]´5©¸ÅmŞ	`;É¶ç‚¿Ù[Ú+ûÕa­9g¯ôm…º©ù'¤	M•õç#P».ŠÁˆ—/ƒgzaK³/½*^ñb3¡eI*Ÿe³ízÑ·=Şm8ƒÃ¡m2Piÿ½sÆƒuùYOÒ–	”û÷´†çco½8Õ=¹ÂqÉu8
7Û3\úŒ5^rv~}ÓŞÙ©çùhÑ¥üuxÊIÙ@*Å‰7+§z^œM!ê.V¬~œ1a¦Ù³gW]]ÊçøO¬ôÈõ¾;ü·C’õêßíÊ­/Û¿s“ˆ$P]Çlğ‡n¾×X!êÜş
7€Ì}¸
!v@¶ıóî0È¢7w¼±ŠeîO]nÊ”K³X¦}ï²j”wâ ?N€Û©}öĞbÒ—¬êş-<—×¢C'LhÖÑHíD4ğ‚Tj‹AÛa“ıÅãjt£Ã“hIÜ½Ïsv(ûz¶ÇrwÑ,-ô[Ii ”şp®bÑ·rË‡õ¸µK`Y˜ÔQ«pş§÷N¬nË¸ÏK Õp4—<¯aŞ~!C²îÔL–ŞÏÆ­}Øˆˆ¯G”@{f¾çzùuJJd†A:Ö»|¥%ÓÊ8÷nUË:ë†X8?šÆµ´ãcCéPZ|*[=RsÑ…î¤Q>Ö|6)†Û¿K3Ğ
v#&Ğ$Å5yßcî#HuIq=±G˜@M† õ,|€0lêZ–|ãIuX+v	?wéş¹¬ø£n-¨Ñ›aÿ§–6FÖİsóS9µî¸Ş9úÖxFî%Éµ_ôE{n¤^î/:C²#'±oõƒ ç3	ùàr]â[?¼–õá³…²ò'Å‘Î¬ßûm[¶Ù½&÷Wsh‰ŠxHÊÉ”Êl£x,Zq$Ñ¦ŸYÃW¾=€R¹Ë¾Q“*Ió)Çc"ë;,à“âFa{‹™>Èù–ÉäáQÇxØF_PÃ¾åÜ^(ĞH¯şPmÓÌª‘7–C\ÿ„°‰î'íÌU<ÙÎ’ó„?ä&1àTY©t…+šfáEtÃ}İ²}(F‰J ÛYİŞ\8.¡»5®*S"™@ûZá`ê¸ƒ@Çß¦il­Şq+›_GÖSâÔƒX¹¨úïómÛ×»pµ?²c™pø©½¿6ËË’~ñ|´œ@)ô±£¤	%µ`KˆZúææ€kXa¿äÅ“éIÂßEæÎ&=u•Âa5Ÿ(¶¿ Ù»+2ZUoñæp®’®éfPòÀKé"÷Â,¥s³æ½ù	$µ~=ôvƒ68ëó‹&×»İ_@ëßˆ yÏNã‡®DB"Õ—+å«çö_¾†çúüv8i$á#<—8ÛWw)jhTŞ“(È.íáOk%JÕòyš%úv:$i
@m>‰rî=üvÀ'Ãªù
ßØ¯ú_£¾åc=ç9²]ädQÏ>%û³Pú¨Á$¹ÛÖş€ù]^ÛğY_MzôÖ÷$KGÖ1 «¯yx¦ï×¾Ä{„@y)°ùìSÌœ¶¥Á¯]œ~~›ƒJèQ&å8¶û^±¤ Øğı	¾8YhÓOrq­¹QK,Ô½ª£=¥±yı‡Ş?I\8ø7O‚ï0ı$
¢·cQp—ÌÙÖá;—O‡èÔøhØi¤ª¯Î•¢º>ñçiø±ã¿ÛÔNÏ’Å”×°Æ½ûôe"rcZ&*¸ä Ú¾Hî49´[ãßNEê_ıq/ dg‚-È’¸µu`MÌN?5‹;ŠUÏÑ±3@äF†ŠWs—9ì5Hù/ŠoKPJ’÷}SO˜q-bœÙéN ŸÍñĞŸO²“iÆönãáQoÚ)8í†•÷ éyhé5ÅNÂÊîô¨»İGé¤~öã[wŠÇ^l
¸™àšê‘@vhä&İ¢Ù5Ú£ªZMîa w.“4FïÌ;£3ïĞşUÃ9ƒ›ÊKdç}u_ÓøUq\J@	é°µu”$}y¥f‹›6IÁ>âì”s‰V—´ÈßTÕ¯<áĞyÇ}çqàiñ>‹tæƒ¯šÄ„_ÄåVT¨!Ûş†l a'y8x?{˜¾¹w=®CbŞí“¯½N	ÿ­ñ%ĞD&q$1¤	¯lR|òÖÁ½Ù4}Ôêèí/aiÇÏ:ºhâéÂİ
ã;-9ğËş­³íêYpÃ±äA"×›BB-îw\ê~•÷¿cœxÑX>$ÊÜkuÈ+Ç×lnİ€KÙh
€Œ]:Z95q$Š¶N°àÚiDæH¡LÚÖ¾µÛ9Òrå•$)=ípGro€Cu¢³œ¢4SÃoBÆgªmÛòùl§ò,ú÷«ÂtúEä\f/XÎ)u²çq¤à+bŒÇÈğ- øæ~ù 1øÖªu	Rœâ”‹!»Ù®]>ÊÕ\]uèöÇ³Ë?‹‡’—X
h~q—VwâÒF›‹ÑXÃİ9W‡±—C~İâoË¹óÄî+GËóˆşóVÜv…$¡{‘Ö“piíÕÌÆ“6ôÈí:W¶¸ÉÜ!…«"š80öòà×²úk'K9BMºe-ı{_Cs÷œÏ©À‹j†Öá‡ıpw!ëƒ×M¥¼™Ï'k]øï´ÒHÔv”ì­yJíÄĞ9¯Ø†?;úÌ*€4]Ë¤|JI²ÒÅ>5ì¤–ÀF•ä¬4HäúxfíCöè(çQn%("©µ±ã^Üî^­‚¢¢xD|¸]§Š´ü6ok·‰©J°ßÁ#Â€!ûA*Iíé,ıªmyÜúğ(ÚØßË­«:}Ü‰¾ğÛPŠ¨®Š b>WÃ¼ÌQ(ğzvÄ™MU^…Â5${e.â^³¤S¡»"6We°Òo!IHÓßèÅ÷[m§VîaÃp¶&ª%ñ˜â]Ñ«§>¦W¶á ğ	|#^O;ŸUÌÔe·ÓcÿáU1ßÁú{²–,äŞ¶Ê	šZµ:²´§ôÄí®"o+tºA;&ÉEü\>=ã¥ x½FÒbµÔ6ú}º¹yÿU½\‚C¯›‹ÓJ|†cd|17–ÑŸ^ÀJùV 2^ÊŸ6SêØ›@÷a~™’„‡vöÜÅÛä¯ª+«è9Y¨Í$‰®W˜J¶2ß¥æÁ@"YÑxüxL¶³ÂÎ˜Ç“Lág³rpn›|±ÜNG•O A/&?=Ô\ö‰åìzô#*Ç.–mäßs›,&1ş1hT—"Ğ®½¬ğga;é"²÷şŒÛ]4Ú—‡‡ğ§FnŠH|ÒS ïíØ9ƒâ¶ş¦Ñ¿‹¥_É{Yl›Š: »wò·Nö¬¸Õ9ÑûÜ¤C½ª°TîÔ=%TÑÉ&úH5ËŸYİ+ÿéi?ô§2tºjàÎö¡ù€Ø¹„Q¬¢"!„õ~IÎ–ÂÜtÌÁnõIºòš	Ïé{ñİ •—ıÕ=u¾0‰qçÒ£ït°sóğk ë"b^Wmz¹§€@GCÉõAoÄñæ|YÛê¡bvÒ‹’‘°$
—é|í¼wl'üé}f¿Îmø=õÓšCCÎ'#JÓ·bQ\© HG£zsÄ¥?MM°o«—Æeù ÏßØäøØ7Æû÷Œ½Ø9}ğ…›~š1)A¢ƒdŒı¶´ÑØÔhû/W'9fB¬&}%ş	=òu:\ÿ5éØÅ.ÇÆğ1-¿ÿ¬nÙºş¬ÄóµïöÿVüï(KtlqdÜw<¿Äüçâ3Cx®§¼ˆH’ú,îuEyá¾^MòJÀ3&u²»éÇÛ‡ŠR¤sûM·gÑ¡1òØ4£ïˆãŒœØí/Õ_Gyâ™)§†rIdÇzó¤—mØSl…÷Ì³¯¿Cv´;0ÆU×u6,s½üßòüV‘ãr¬/œø×6à@çAÂM’x®š';qƒNÜ¤ËU™|nÜì_¾ğãt`FŒó}ÆÁ—ŒŸŠÇĞ¡!møçñÀ¤:ºãåi«Ü•’ë)8Z©‡EÒ‰q	$Ü#ykÚyq=#‚«`i8ˆu†Œ6Ÿ«~7›{Ò’‘J ‚5iÊ§„ĞR˜i&ßõ¾ú÷	®ÇêEì¤æÄÇêh¹î6yP›–Ü XN+ı–Z79îùg¸P8›xpúÎ{U…â:^X$½Mşâ÷ÏKMECñ›$j†í[IGû/š=ñ¸§“™ã–ª—¤Í€Ğ¯İÏW	~á#¨:2O ê'å'õÚ?((´ÏZª‚¶G7ü<ß­N]Xf¡xPSi„a{Ø‹ó-™Ô<§—5ÒH×†šR§(Â8KîæİÙJÄˆğÍ?å4‚ÕiìRRïùœ°úá6·Â…KÒ­ÉG^´PÙ$/ã&Ûƒ“VFî$™’-ôˆv38]jÿ¾RÁåIlÄNŸÿf¢}µİ}bO’	n<nãéLËU•Œx»µuèÄIXÍ.mÒ †Í°à½¾hÕİˆò}`€·Šé)hÎ¼xæñ÷ŸX_?Í‚}Ò1?,şYiëcyì„§vêM<!«Ëî‰F?·¨Ù,ÆêÁ]˜Àİ.ÁYÅÎyqë˜üú”–GcI`ÆÉ„+—À‰¨yî›‰>Ÿ)ˆgNŞ'¬Œgr¹2äí¸ø}éğ']feÄÆŞ”HàÓúÆ\RûØ(ØKç'àyø„CÛÙºsŠ¼a»o7‰9K¶_½ŠÇ;'$YgõÓüìı²‰«Û‡J°÷6àÂµ>J’3‘Ÿ˜\Œ+¡Ôìz¯Å’$ó§cğ®À½i¼/™pßÄƒMUãº
ñûÉüícÏË°iƒ¤İ©ûùáe/,õÎ']¨×çÛ]†C½,ÏBšÔv@\‹ftM‡Ø&ÛÍÊş;‘½.î— dğzi²%cïÃ¦”ßWğ OV‚Æ¾‚ö¸¯>7Êˆ/)âÁb@£Pn{!»Û¸fĞ \¶ğü@©-â9yğ@ğrVW±9³n]úN·:z°];w1(^4«€îãÏùñ¼ıùØã	àù|é‹ºş’FòYâTï9ÜÙ&ß²iâ^ŠC~‹¦no]Œ®Ä/=8A Àø;ŒU
Å!ìËÇå]¿NŒh<.¡“–§Ê“pï©ê£ò9õl¯ƒ¿b±CPÎ²—2æñ0eB<…­Ò¤	«¶Œ6¸JºiÉ@&Z]¨”8,<vwO²ë‘ÂÿşH˜ÚÑ ©z—ëúÒr/Vëá!ŒØ-óÈÉ{x{B™ÉyDñÆœÊ"±/0•â¬ ¤c­šŸ~!™ƒ@*Û@õ&“ähIÎÙ´ÌwÛú*>ı$PO.á%]Š04ôWOÄ+÷!ÏÂ¥$ŠXÃ”rpìıFÙ>ã_Ušª=D‹cl^ éÉcÓ|¬›?çˆã¨Øá;V£Î$¦­ª×|ûìv#w!ÎÕÃ³ã$Q#(ò/7ÊtX}Gÿİ=Kª{%€U²2Ü¿C{‰Š%<qÕaÍò(Il²ßw¼NàËxàˆ…ï[ì°3”_¿öFEÕdšjY!Ğã4,PfU€0™³ß}ÿç~­ŠĞì‰úaÛ­ô}¡ÕØÉ¤ã’U(iB@Id|Qƒ*$Éú¹ùZÊşè•lZ\L”ñV
Uƒñrÿ•B[FrhÒ…¯*O±¢e!së]2+ã›¼;y@ù8˜áó½d%ğ~éğÒç;)^¿qÜıWÜö¯Äiámˆ¶é~™ôk}0'c®$©ñ×aŸÌã†Ïäñû¯î“ÀÜ›$:»İ•;V*üûşp5fì ‘„Ùågk¦š{ŠK'.ÇxNX‘ÑâÃtj{¿ï-šÑû¡x.1¿áÁúâI²BŞz¹Hıbñµ¾a¼”u4ÒÍo©mÒÚ4nüô«Uí‰ü†İİ5R}´„œüÖ#şŠobB {c°—v@9UòÑkk˜ÃÍ§xúÓÃÉ,ºĞhé7â6ñGû=«Ò¡¡C1FğAV½ú·ºßéßO'[›I•ÿ†ı9n$y¾~85`Ë¦3É_±“˜³Æ20^HóLû‹ğv)ÿ	/	$İ¬D¹W` uœş½%£Ø0+èpvVˆÚpvŸ¯1$bYû|"¯vÛï)VÿûØ‹í†`üˆ	Êæ6lã2õÅ{‚dÿ˜í¿©g`
Pî®€új
]–g>¡gª“>$!ØŠ{{ç¥ï•tñ‰“BV‘úı‡šèíïÄ}ÚmJM}gìt{F}İÈÍ«ôÆŸ ƒí5SÑØñí½¶Û‘­@DuÍŸXËD¦éDJâwê…İ,Òı²ç³Yº/Éö+'mÇ[şn…¢Ù%c½Ë°Ì%M‡Ş“'ìKG EKÈkÃ¶–S¨°p#¥ŸZd	fFéçîL‘[ú~‚X…êS©ÖDïò³çGßn_Ö˜ò@+ºZ¸¨;v@v^{§XÕë_xP­‡@‘°ueÀÈu‘êß¥a—Q­Ê<’à6¢9’lx\æwÓóNwUNcm‰]¢¸#TüûÔ/•V³°Ş‹’¯±­Ãf:D?VÊû‚l­ºu÷®^ÅRç8Ü)°ĞÄûùIa³{½añè6ê¼”ÆØ\“\ô. yŠ@NÃ°WzZ›/,Ø¢uÿÌZå^=Ü9Ú0´Ö»Àóá†¶ËÇıØõ&öâvs 2š®PN«ë\”pÒã—^3Ráÿ»ôáuÅYf½5ğû¦Á6 ¸›@¥X\÷¹ñØÍd•|/§_Ã$Ç »9áßGaO µz*Œ²Ê25mŞæÉrÕåÄvÄÓ
úÓ%²àïa)[ã[…C"X«~Ôi9nºê”çæˆ­â8(C)$Q«ßp×¿çªœš@"¬’İ Da§‘^6º´AqFÎy(|»ªÊ6:´KÖ^ø@‚¢»í§¸(OŞZ`}5{(U}´\):Æo-œmÖf¾™@§Åpã˜ùa¿æ|lêÀd¦Æç»mšÒ·âDYZïdpâo{áN*–,öÕtø=OùÃ¨zT“ÔQ±¼Ç!­å/=ÚXç@¹‘Ô¾^“õEß·…+f¯œj×âş»uÙƒzà  ï=“´¥e«5½xŞ¹[ÀŞàgAP×ĞF£sÈŠ®í&–ÜŸ2¼[…5÷k½–{§=ëöüA!ğüùµ3Ú¢êİ7xùHñ¦®òCPHqÅ½ğb«·­eš"èÑvˆ5bHdR°“¶¢Æşøò¿É»‡è÷&>íøáCß†XÛJæÚ-q¬VsVõ¢ö·’¶q©/wÁÀ@±É¸’ˆ/¾/ëÛr:Ï<öÊäz”2EH…¥Õ‚+3obR_aehiÎ„Áãêt‰^:¾árß6lÀço6M$b<N¦Æ2Óı=2Œ»vaÀ&,®öL"Iİ}S¡³!B©%ÅN8:ŸJ£…Õ$ád™¹æ¤Í…c–U˜¢ÃèOD|Áés‰ŞN;{›{\”à8¾ İß“LØì2îøí¤Å*ï®£~ÉSQ@ö¾~k–hÇL93š=½/Å6^ç¼Ò€˜OÌúùtİS@¬‹€KGNÇ@¢úÉ–ÄFuÜ1¼	8yk„•äé²Ï¦¥÷”ŒAïUI"	J:rˆ…ìT†½£‘Ê4Qû•I„‡¾7qvßÈDÉï’Î˜É„õw²aÖâ½1PqŸ<!×Ï±­”@gw3cçèC…ìdÃ8¾öJ‹•%üÿ©|sT²GGMo†5ÇYµˆ’EM²q9¨ÇåC¦Ùè<"Â$şHóü‡O’‡U“ÏK„oÆ|ÇşIù'Ó<¬İ±¥îSíÌVè¾x‚© øx¨BqÖúğÒ7ÅÂÎº»Ğ¡:|4ó¨†Dº?Rb›|ª4}„Âúñ`¡Ç¯t7òÛ¼×PAç,cì÷Ûü\X&E‰á’Jp¬«f¼˜xõåMÅ¬øÙMÙpøÊšÄô¿}Ø€Ü×ŸaÓ¢Á]XºÕ}ŠT¿jé;×nïoÆ1‡Ä± <LbNI;9(4åî^<u˜7İ—*6ÜGÏ iQI:IHßWÈ2C °+Œ”£Tù³@z½R]üV,tì%Ğr0œ³“$÷›RµjîïøgŠìØc×ğûh¥À«vué0?V²ËùŞ/ M‡LáØd•sdÔQ~'ÚàŒ¿Â3Ş·xtóÆI`‹TF’½ábš‡·¿8r·ï“>üÏòc/¦Bÿ”¥/‡ìK²ûåÄ@ û_™)óÈ eoP	q„±àÀÉ…÷]°CËXsœ¾-¦wHv»¸±ròàz(íóPĞú››2ÑáŠY5m7íœd¥¡*\€¬¶¯*ï\§ö8ygæ)qMÁıÜHD7ß•CIÓËWÅÑö…?.cÇĞ­×$ìk!Äm^Møi`G·L3Õ!Rh_~Dkó]ÿ¶tË;G_ØÑÍy	È›[,ÍÎÏ-˜_o¬#¡ +ÖØa$‰?1O¬Û^ºƒƒ‘¸`Eì
«}CìÒé÷å[	Äãî ç3]Ò8¤ğïoƒ’Î¼v%/=ª¸‘ƒ7J&á¯ßÖ—Wj‡r\•q,)Á„cÉ|’Ø=g?wãóv'±ázô›k?ï´á´„ÏìWşˆ1G6Ó°+ŞğŠ“IˆcÈê÷I]´(gŠ»$4vš@üù"¸ëÓóÉşµÎŠè|ó‘v%ËÃ|<’H=·|$¨%àV½÷Øà;QäÄo°®šOÏ˜;ß»>¸Qf‰~¬ŠbIr¢#Äh`°{ÜEEkú¿c¸k+·xQšgvØ™qGc#ŒDÈ__<RSVñ:%Ÿ¡‹}]™öh~EË©)I^Qêş|3ğH±ã’SnÙôâÄÆ Oœ3ù—Ë/cd½r:`s‘'Æ¸¶vé<QŸf¢X ÆbaÌğ{ıt¨Yûd±ZÅ&O‡;ÀÈv.†¼î^:Æ$>>ç{Ø»öı´ØÌõCsük%öHéòU^Qºuxæ?‚ÁK ‘Rqñ÷K¶å[zãn#ĞÈ	IÊ;ê¹2RM7sst:¶ÏŠxI ÚJ¦÷•Éf}oÏzáµ$³±úï~^”yHÁäÍ/Ş†9¾92ƒık°œ°œ$ó×ÅjÅw„r–¤2èÍ_8IÍû.ÓuüÉú/U£?V÷Â}°¼øIŞMÊ<èŒ6à a¯úÍÜ_Aê§Şºåù~¿ÿì<7lëáx®ÿˆGüõÿª˜| Ğ‰•9šA´»’lê¢/é&8x#M°v…#§¶T94¤R¢uóã6ÏcD9ÚÒLx:¸Uyï”{‡{ò›ÉMÆÕ"mù’İ'M-oíÌ?ı[ıø†«›@×"¹pp H’yµLFN_± E3l›î(ÀÀG›ê–™·ßäTMl
Âcğ´œe¦Ù 
æ¬ÌôS†_Bÿú¬*éQ.ënHõ-4’óégRiC'$Ê¯ÿ¡ÅæyÂJ‘&Òµ%é~Èå}Šö¯%:•`ïÿÑtŞX}ÿ÷ğ\;{–½WQ6Ù¢•ÉÈÊ.¤’tÇè*£R)”‘ÉHJ´¨¤„¬Œ"•T¤ßyß~ß½¼Ï=÷œ÷¼Ï¬wÉ$nŸ]³Œ~İ/MÛX§ímm±NÛßm@ı¢ÊŞ—
s_Å&Å[ü[ÖX†Ô^x{–Ú¾êˆYv±_š¢¹`Ÿ5H’²îÖî9?'ñ™>lV3½,xÎ{Ú¡ãÂõK-=­òÎWNbFjÙ°YÎ
}j‡G%¬½+L_–L|Å°…Š"4ak¿Ü™W´
o–±—x¦iˆ«¼Ç(È.Ø¡exó~ƒ§A~U;ÒàrØÏ<ïÙÍsÏØ³íîªv†ÕórôõÉ8ß”Åµ–7	;Zát5)ˆère_Æ­¥×ë±Cûpƒ\Ó£ûHÇCC…€×z¶?9tóßú4Z\[^şT!Í±g_ˆ]8î7‡DœOÈ¬dcÏİènË+k7Œ	aß§‡Ãš1IÄÛ?ü¼W[ºl#F‹Æa-U¸’…Á7·ÚïO.yVà¢/~„{#µç@Ü×h¼xªÓcâ‹.—CeeákŞƒ)5ë;Ò{DG‡Şğ•ş[UïN“ê!Õ³_øÕÈ0—ÅåX¤¾ƒVB|/İ¼ôõûÒ%Å})=+)bp¢×½&û½èÏqI³iıèûë;±'UƒC:¸ûaêíë³mz«•şKcF“jëp‹ŞAk=u"jfúÚÓq8Ş&Î†Gnã  š³ÜÙö}¸“À èAE[ÉRš6Dœ{Š”°õ§´Fkµ$©	•ù-’¼û¯ı”¼¬¢¼]‡¶°¥p!<Eã$a¬«yr'›Í…âˆó"ã4Ê]Úapu-wÅuÙŠwÏŒè×­é¤"¹ÊÓòæŞÅœÌŞ˜µ_:ãäÚÅ‡m?bÚªiz^·ÕÜjbCOÕİd‚[pG¡Ó­Ó|F7¥Óµ¤£¢¢Äs.ó‘Ã…À(ù	`§—Dht?ì©®eÂ^ëáĞNÑ.–\wšĞ¦<f$u“_CñDÆA°¤Ğ¿wø×n¾›.«pš>(™‰§ü™C_O½œ¼§ÕûÌº,<æaOI«ØI£L’	æâ>öôÒ/E‡¦oÄ	Ãë>CPòÇó9óÆCì‘ÂÊ7‡=”0!„5ÂsŠt„ıëšü=ã•zûÉ5=¼ÏM)¤½›"/üßîía{(U|i$Î€PÈ@ĞK¶¬#r+ïâšäV½­Ÿ€¬™;¿ÙE´«O_MOîUsè\$­í3@æ*MS]UãúG?èU ºÁ©G%}ÁæôìÂ^Ç,¶6*;Îı³@‹J•¹Ê<×2.\ÎvGˆQîĞs¿‰ªÙ¤¸‰åû±pQ¸1Ü:øz>ğgsY/Ë‹“{\pağ¦l5WB€Ş#×˜ˆŒ÷‡¤}¶ßÇ©ÓïŸ°µTîı;	#‚ùRšå)§ù×
Z-D¹—TN
$›Ø¨„5şÔ”´"ŞP‘€1ì“ŠXôqø~­ÜÛ6Û:›ºx¬e)*”“IÛ–ÉÏ
-OÙÒ•ŠBv\UàÄıV°ô1LTÏ^r‹ÿ¾â´»™‹@„ ¿üŒb¸¹/·<EîM<Xœò'UŠ7à¢"OF2×T}©¢{OÓS@;Ó°Šk’
$ŸƒË‘ı}½Bòk4¹6ôË	 *àM–íWë¹ë›fö#Ğì)<ª$ù4 µmii§qÔe¬³*]
°K“EZpvßÕ\}±ó3J9ï	Ãóëe•æÒôû›³^ıâZ/eíâ.4Ä·¦RÁØ¾ğt˜å{ØOİ$Ç
äºù™~o!Æ?Oa§!&Œu$—HVPNÄÂ3ºúTYY½Q¡d n1\ïËıı:éat‹3¡°V/n6Lö†0zˆ¥7°<·ÒURMa;O İãÒØ
q‘u-şÊöõ}‡f'v®¶¸ÓòÌÁogo¶IÈnÍÛ‰³qy)6<œÅÜğÿ9óKf^Êqk‹¨‘8zr5ø€¬CªLİç>6fïŠÛŒçMœ‰
?6Âıd"Ÿğá@v.œl¼¥âTâ+IöØŞZ>à\B=¥×9üïT'z ãäøµ›t]Ã÷›RÇ•ëM8ÔVŞ
­øâèIÓÃ;^İÿÊ;J t6ÍÉoB;E ããû3÷|!?ì„l+‹]5b8„®ˆ€ğ—tå}‰Üq}à8§!²àB IQhÓı@ô(Š?üŸ…Á¾ú[7`2¬!'¥u6·gŒİK¹{ÿ?0·%n ‘Øµ©—¿
f9Ó°Yj²R¸hK€$&¼-Îñ&ªÛ×ôâr"wÖ‘qIÁ£¶<"¢$³|ä†”æ±å_‡_àçHB7ÎßÉ¾<×Ìy}Ê{®!Xa*„BÓ¹œ4àRşïğ
>P‚y’Ù!u4Çn7£É…;ş¸H] Yµ–ü¿’×-!Ÿø£›òŒÆ	´'šŸbH/“²yÉmÂş„’Ü‹?ÃCrY–À2Óò@_æµÑĞ*ìÑÕë{#‘|¹ÿwáãè÷ƒ{â±÷™ø¥g")I+³”4ªyRôƒŞ†S¯y^Š4ı–
ÌÃ†'Îdë+ºtUÎÁ;àµ~5=ğójØÓ•š´XÓÕªÂïé²ˆ‰ïßRù¡­[ØqJlşœ>}Êûë]òoeè]§(ê:'h½:‘‰o­öGôğ2À~©öûªÃ$¬ñêe¿´Ş”yXB½™Šfá[ŸÉY=c÷Iù²ë¤#äX©”Pº­&™~UXÜŞÈ#9rÿ®élœ©Ø6i2›•|k®`·å¤3®mÍxWã`°CÚ{púfñÍôvœ“ˆã¬øIt7iäæïoØÄ‘®âE kÏaA±¦.°•?¢É»tÂjwMˆr;Ÿáò'‰™°”ÌÁ5zvã.`Áë¥Dq8ùçó˜'<gh§T	t%İ÷`NH¾Òä´ëoÛ‰éc­Ú²[“P IlUªéfÜA\ÌnØE÷›€½¬EÓ$¼¾aÏÑq-†¼¶eSªòÑ¡°Ñ×’³„ê»½Ô\öy3±8ˆ+à\ÉÈ•˜«V©–íÿ